...
const AccordionItem: React.FC<Props> = ({
  ...
  function apply() {
    if (proxyRule.targets.length == 0) {
      ...
      if (rule.id === "") {
        createProxyRule(rule).then((response) => {
        ...
        updateProxyRule(rule).then((response) => {
          console.log(response);
      ...
      <div className="accordion-title">
        <div className="accordion-title__source">
          <div className="accordion-title__source__wrapper">
            <input
              className="accordion-title__source__wrapper__input--left"
              type="text"
              value={rule?.host}
              onChange={updateDestinationHost}
              required
            />
          </div>
        </div>
        ...
        <div
          className="accordion-title__open"
        ...
        <div className="accordion-title__delete">
          <svg
            onClick={() => deleteProxyRule(proxyRuleIdx, proxyRule.id)}
    ...
    return (
      <div className="accordion-content">
        ...
        <div className="accordion-content__column">
          <ProxyHeaders
            proxyHeaders={proxyRule?.headers}
            updateHeaders={updateHeaders}
          />
        </div>
        <div className="accordion-content__column">
          <ProxyTargets
            proxyTargets={proxyRule?.targets}
        ...
        <div className="accordion-content__column">
          <ProxyLoadBalancers
            loadBalancer={proxyRule?.load_balancer}
            updateProxyLb={updateLb}
          />

          <div className="accordion-content__buttons">
            <div className="accordion-content__buttons__row">
              <button
                className="accordion-content__button--cancel"
